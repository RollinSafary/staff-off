...
const translationFilePath = path.join(__dirname, '../../public/locales/en/translation.json');
...
if (unusedKeys.length > 0) {
  ...
  fs.writeFileSync(outputPath, JSON.stringify(unusedTranslations, null, 2));
  console.log(`\nUnused translations written to: ${outputPath}`);
}
